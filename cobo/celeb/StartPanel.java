...
public class StartPanel extends JPanel
{
  ...
  public StartPanel(CelebrityGame controller)
  {
    ...
    this.movieClue = "Enter the clues for the movie celeb seperated by commas";
  ...
  private void setupLayout()
  {
    ...
    panelLayout.putConstraint(SpringLayout.NORTH, literatureRadio, 40, SpringLayout.SOUTH, celebrityRadio);
  ...
  /**
   * Used to link all Listener// Yatlongstan :: Yat Long, Gabriel, Weichens to the associated GUI components.
   */
